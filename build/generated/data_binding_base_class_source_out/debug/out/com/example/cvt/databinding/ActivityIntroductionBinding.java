...
public final class ActivityIntroductionBinding implements ViewBinding {
  ...
  private ActivityIntroductionBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appBar, @NonNull FloatingActionButton goContact,
  ...
  public static ActivityIntroductionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityIntroductionBinding((CoordinatorLayout) rootView, appBar, goContact,
